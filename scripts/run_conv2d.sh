...
# sbatch --array=1-3%2 -o $OUTPUT_DIR/%A_%a.out -e $OUTPUT_DIR/%A_%a.err $SCRIPT_DIR/conv2d.sh $1

# The full script
sbatch --array=1-72%30 -o $OUTPUT_DIR/%A_%a.out -e $OUTPUT_DIR/%A_%a.err $SCRIPT_DIR/conv2d.sh $1
