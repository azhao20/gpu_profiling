...
# sbatch --array=1-2%30 --export=ALL -o $OUTPUT_DIR/%A_%a.out -e $OUTPUT_DIR/%A_%a.err $SCRIPT_DIR/time_bmm.sh

# The full script
sbatch --array=1-76%30 -o $OUTPUT_DIR/%A_%a.out -e $OUTPUT_DIR/%A_%a.err $SCRIPT_DIR/time_bmm.sh
